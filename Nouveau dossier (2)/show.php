<!DOCTYPE html>
	...
	<style>
		...
		p{margin-top: 0;}
		imge{width: 375px; min-height: 250px; margin-bottom: 10px; box-shadow: 0 .125rem .25rem rgba(0,0,0,.075)!important; border:6px solid #f7f7f7;}
	</style>
	</head>
	...
	$image_query = mysqli_query($result,"select Nom_S,Photo_S from services");
	...
	<a href=""><imge src="<?php echo $Photo_S; ?>" alt="" title="<?php echo $Nom_S; ?>" class="img-responsive" /></a>
	<p><strong><?php echo $Nom_S; ?></strong></p>
	</div>
