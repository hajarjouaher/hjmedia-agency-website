...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `contact` SET `pre`='$pre',`nom`='$nom',`tel`='$tel',`email`='$email',`msg`='$msg' WHERE ID_c = $id";
...
<div class="background">
  ...
  <div class="container">
    <?php
    $sql = "SELECT * FROM `contact` WHERE ID_c = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
...
<form method="POST">
        <div class="form-style-6">
            ...
            <input type="text" id="Prenom" name="pre" placeholder="" value="<?php echo $row['pre'] ?>">

            <label for="nom">Nom :</label>
            <input type="text" id="nom" name="nom" placeholder=""value="<?php echo $row['nom'] ?>">

            <label for="Tel">Tel :</label>
            <input type="text" id="Tel" name="tel" placeholder="" value="<?php echo $row['tel'] ?>">

            <label for="Email">Email :</label>
            <input type="text" id="Email" name="email" placeholder=""value="<?php echo $row['email'] ?>">

            <label for="Message">Message :</label>
            <input type="text" id="Message" name="msg" placeholder=""value="<?php echo $row['msg'] ?>">
