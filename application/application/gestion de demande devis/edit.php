...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `devi` SET `Nom`='$Nom',`Prenom`='$Prenom',`Email`='$Email',`Tele`='$Tele',`Description`='$Description',`Budget`='$Budget',`Message`='$Message' WHERE id = $id";
...
<div class="background">
  ...
  <div class="container">
    <?php
    $sql = "SELECT * FROM `commande` WHERE id_comn = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
...
<form method="POST">
    ...
    <input type="text" min="2017-08-15" max="2025-08-26" step="7" id="dateC" name="dateC" placeholder="" value="<?php echo $row['dateC'] ?>">

    <label for="Total">Total de commande</label>
    <input type="text" id="Total" name="total" placeholder="" value="<?php echo $row['total'] ?>">
